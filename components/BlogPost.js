...
const BlogPost = ({ post }) => {
  return (
    <article key={post.id} className="mb-3 md:mb-4 p-4 md:p-8 transition-all rounded-md shadow-sm relative bg-white dark:bg-gray-800 dark:text-white hover:shadow-md">
